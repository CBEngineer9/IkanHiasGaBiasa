            ...
            <div class="col-md-9">
                ...
                <div class="main box-border">
                    <div id="mi-slider" class="mi-slider">
                        <ul>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan1.png" alt="img01"><h4>Penguin</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan2.png" alt="img02"><h4>Discus</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan3.png" alt="img03"><h4>Guppy</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan4.png" alt="img04"><h4>Cupang</h4>
                            </a></li>
                        </ul>
                        <ul>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan5.png" alt="img05"><h4>Komet</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan6.png" alt="img06"><h4>Louhan</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan7.png" alt="img07"><h4>Koki</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan8.png" alt="img08"><h4>Koi</h4>
                            </a></li>
                        </ul>
                        <ul>
                        <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan12.png" alt="img12"><h4>Arwana</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan13.png" alt="img13"><h4>Neon Tetra</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan14.png" alt="img14"><h4>Mengbadut</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/ikan15.png" alt="img15"><h4>Tetra</h4>
                            </a></li>
                        </ul>
                        <nav>
                            <a href="#">Ikan Biru</a>
